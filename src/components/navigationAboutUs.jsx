    ...
    <Navbar className="sticky top-0 z-50 max-w-full rounded-none py-2 px-4 lg:px-8 lg:py-4 bg-black">
      <div className="container mx-auto flex items-center justify-between text-blue-gray-900">
        ...
        <motion.img
          ...
          width={300}
          height={90}
          className="md:h-16 sm:h-12 w-auto"
          whileHover={{ scale: 1.05 }}
          whileTap={{ scale: 0.95 }}
        />
        </Link>
          ...
          >
            ...
            <motion.li whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
              <Typography
                ...
                className="p-1 font-normal"
              >
                <Link to={"/about-us"} className="flex items-center text-orange-600 hover:text-orange-600">
                  ABOUT US
                </Link>
              </Typography>
            </motion.li>
            ...
            <motion.li whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
              <Typography
                ...
                className="p-1 font-normal"
              >
                <Link to={"/contact-us"} className="flex items-center text-gray-300 hover:text-orange-600">
                  CONTACT US
                </Link>
              </Typography>
            </motion.li>
        ...
        <Link to={"/contact-us"}>
          <motion.div
            ...
            whileTap={{ scale: 0.95 }}
          >
            <Button className="hidden lg:inline-block bg-orange-600 text-white px-6 py-2 rounded-full hover:bg-orange-700 transition duration-300">
              GET A QUOTE
            </Button>
          </motion.div>
        </Link>
            ...
            <Collapse open={isOpen}>
              <ul className="mb-4 mt-2 flex flex-col gap-2 lg:mb-0 lg:mt-0 lg:flex-row lg:items-center lg:gap-6">
                ...
                <Typography
                  ...
                  className="p-1 font-normal"
                >
                  <Link to={"/about-us"} className="flex items-center text-orange-600 hover:text-orange-600" onClick={() => setIsOpen(false)}>
                    ABOUT US
                  </Link>
                </Typography>
                <Typography
                ...
                <Typography
                  ...
                  className="p-1 font-normal"
                >
                  <Link to={"/contact-us"} className="flex items-center text-gray-300 hover:text-orange-600" onClick={() => setIsOpen(false)}>
                    CONTACT US
                  </Link>
                </Typography>
              </ul>
              <Link to={"/contact-us"}>
                <motion.div
                  ...
                  whileTap={{ scale: 0.95 }}
                >
                  <Button className="mb-2 bg-orange-600 text-white px-6 py-2 rounded-full hover:bg-orange-700 mt-4 transition duration-300">
                    GET A QUOTE
                  </Button>
                </motion.div>
              </Link>
