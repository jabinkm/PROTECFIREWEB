      ...
      <div className="container mx-auto flex items-center justify-between text-blue-gray-300">
        ...
        <Link to={"/contact-us"}>
          <motion.div
            ...
            whileTap={{ scale: 0.95 }}
          >
            <Button className="hidden lg:inline-block bg-orange-700 text-white px-6 py-2 rounded-full hover:bg-orange-900 transition duration-300">
              GET A QUOTE
            </Button>
          </motion.div>
        </Link>
            ...
            <Collapse open={isOpen}>
              <ul className="mb-4 mt-2 flex flex-col gap-2 lg:mb-0 lg:mt-0 lg:flex-row lg:items-center lg:gap-6">
                <Typography
                  ...
                  className="p-1 font-normal"
                >
                  <Link to={"/"} className="flex items-center text-orange-600 hover:text-orange-600" onClick={() => setIsOpen(false)}>
                    HOME
                  </Link>
                </Typography>
                <Typography
