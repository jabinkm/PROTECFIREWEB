    ...
    <Menu>
      <MenuHandler>
        <motion.div
          ...
          whileTap={{ scale: 0.95 }}
        >
          <Typography as="div" variant="small" className="font-normal cursor-pointer text-orange-600 hover:text-orange-600">
            OUR SERVICES
          </Typography>
        </motion.div>
      </MenuHandler>
        ...
        >
          ...
          <ul className="pl-3">
            {division.subMenu.map((item, subIndex) => (
              ...
              >
                <Link to={item.path}>
                  <Typography variant="small" color="orange" className="font-normal">
                    {item.name}
                  </Typography>
                </Link>
              </motion.li>
